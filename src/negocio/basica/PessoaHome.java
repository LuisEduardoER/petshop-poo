...
public class PessoaHome {
    ...
    public Pessoa merge(Pessoa detachedInstance) {
        ...
        try {
            Pessoa result = (Pessoa) sessionFactory.getCurrentSession()
    ...
    public Pessoa findById( int id) {
        ...
        try {
            Pessoa instance = (Pessoa) sessionFactory.getCurrentSession()
                    .get("negocio.basica.Pessoa", id);
            if (instance==null) {
    ...
    public List findByExample(Pessoa instance) {
        ...
        try {
            List results = sessionFactory.getCurrentSession()
                    .createCriteria("negocio.basica.Pessoa")
