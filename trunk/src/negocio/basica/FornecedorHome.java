...
public class FornecedorHome {
    ...
    public Fornecedor findById( int id) {
        ...
        try {
            Fornecedor instance = (Fornecedor) sessionFactory.getCurrentSession()
                    .get("negocio.basica.Fornecedor", id);
            if (instance==null) {
    ...
    public List findByExample(Fornecedor instance) {
        ...
        try {
            List results = sessionFactory.getCurrentSession()
                    .createCriteria("negocio.basica.Fornecedor")
